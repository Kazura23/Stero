...
////// Lighting:
////// Emissive:
                float4 node_8453 = _Time + _TimeEditor;
                float4 node_2520 = _Time + _TimeEditor;
                float node_453 = cos((node_2520.g*_timenois));
                float node_716_ang = node_8453.g;
                float node_716_spd = (node_453*0.2);
                ...
                float node_5327 = 0.5;
                float node_4683 = 2.0;
                float4 _node_2965_var = tex2D(_node_2965,TRANSFORM_TEX(i.uv0, _node_2965));
                ...
                float node_9430 = 1.0;
                float3 emissive = (lerp(lerp(_node_572.rgb,_SkyColor.rgb,((_node_1485_var.r*((node_453+node_5327)/node_4683))*(_node_2965_var.r*((sin(((node_9730.g+node_5327)*_timenois))+node_5327)/node_4683)))),_HorizonColor.rgb,pow((1.0 - max(0,dot(viewDirection,float3(0,-1,0)))),8.0))+(_LightColor0.rgb*pow(saturate((node_9430 + ( (max(0,dot((-1*lightDirection),viewDirection)) - node_1476) * (0.0 - node_9430) ) / ((1.0 - (node_9367*node_9367)) - node_1476))),5.0)*_SunIntensity));
