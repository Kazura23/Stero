    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                o.pos = UnityObjectToClipPos( float4(v.vertex.xyz + v.normal*(0.02+(distance((o.uv0*mul(unity_ObjectToWorld, v.vertex).b),_WorldSpaceCameraPos)*0.001)),1) );
