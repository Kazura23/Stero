    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                o.pos = UnityObjectToClipPos( float4(v.vertex.xyz + v.normal*(_out+(distance((o.uv0*mul(unity_ObjectToWorld, v.vertex).b),_WorldSpaceCameraPos)*0.000001)),1) );
