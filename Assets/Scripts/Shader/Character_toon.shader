...
Shader "Custom/Character_toon" {
    Properties {
        ...
        _highlight_amount ("highlight_amount", Range(25, -10)) = 2
        _highlight_speed ("highlight_speed", Range(1, 3)) = 1
        _highlight__force ("highlight__force", Range(0, 2)) = 0.0829498
    }
    SubShader {
        Tags {
            "RenderType"="Opaque"
...
////// Emissive:
                ...
                float3 emissive = (lerp( node_6364, lerp(float3(node_6364,node_6364,node_6364),_highlight_Color.rgb,(pow(1.0-max(0,dot(normalDirection, viewDirection)),(_highlight_amount+sin((node_1442.g*(_highlight_speed*7.0)))))*_highlight__force)), _highlight )+lerp( node_6364, (_emisive_force*_MainTex_var.rgb), _emissive ));
/// Final Color:
