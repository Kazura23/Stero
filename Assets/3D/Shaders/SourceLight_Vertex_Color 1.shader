...
/*SF_DATA;ver:1.37;sub:START;pass:START;ps:flbk:,iptp:0,cusa:False,bamd:1,cgin:,lico:1,lgpr:1,limd:3,spmd:1,trmd:0,grmd:1,uamb:True,mssp:True,bkdf:True,hqlp:True,rprd:True,enco:False,rmgx:True,imps:False,rpth:0,vtps:0,hqsc:False,nrmq:1,nrsp:0,vomd:0,spxs:False,tesm:0,olmd:1,culm:0,bsrc:3,bdst:7,dpts:2,wrdp:True,dith:0,atcv:False,rfrpo:False,rfrpn:Refraction,coma:15,ufog:False,aust:False,igpj:False,qofs:0,qpre:3,rntp:2,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,stcl:False,stva:128,stmr:255,stmw:255,stcp:6,stps:0,stfa:0,stfz:0,ofsf:0,ofsu:0,f2p0:False,fnsp:True,fnfb:False,fsmp:False;n:type:ShaderForge.SFN_Final,id:2865,x:33773,y:32756,varname:node_2865,prsc:2|diff-3422-OUT,spec-1109-OUT,gloss-1319-OUT,normal-4740-OUT,emission-3853-OUT,alpha-6709-OUT;n:type:ShaderForge.SFN_VertexColor,id:1312,x:31689,y:33763,varname:node_1312,prsc:2;n:type:ShaderForge.SFN_Tex2d,id:3309,x:31591,y:32147,varname:node_3309,prsc:2,tex:2325e7a2f6ef2504e8d37a3763f19b52,ntxv:0,isnm:False|UVIN-5636-UVOUT,TEX-8193-TEX;n:type:ShaderForge.SFN_Tex2dAsset,id:8193,x:31267,y:32145,ptovrint:False,ptlb:MainTex,ptin:_MainTex,varname:node_8193,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:2325e7a2f6ef2504e8d37a3763f19b52,ntxv:0,isnm:False;n:type:ShaderForge.SFN_TexCoord,id:179,x:30614,y:32703,varname:node_179,prsc:2,uv:0,uaff:False;n:type:ShaderForge.SFN_Rotator,id:5636,x:31301,y:32704,varname:node_5636,prsc:2|UVIN-6563-OUT,ANG-1585-OUT;n:type:ShaderForge.SFN_Slider,id:1585,x:31015,y:32894,ptovrint:False,ptlb:Rotation,ptin:_Rotation,varname:node_1585,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:-10,cur:0,max:1;n:type:ShaderForge.SFN_Tex2d,id:2958,x:31591,y:32469,ptovrint:False,ptlb:MainRM,ptin:_MainRM,varname:node_2958,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,ntxv:0,isnm:False|UVIN-5636-UVOUT;n:type:ShaderForge.SFN_Tex2d,id:8214,x:31588,y:32291,ptovrint:False,ptlb:MainNormal,ptin:_MainNormal,varname:node_8214,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,ntxv:3,isnm:True|UVIN-5636-UVOUT;n:type:ShaderForge.SFN_Tex2d,id:2562,x:31757,y:33109,ptovrint:False,ptlb:Detail1_color,ptin:_Detail1_color,varname:node_2562,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,ntxv:0,isnm:False|UVIN-6782-UVOUT;n:type:ShaderForge.SFN_Tex2d,id:2887,x:31757,y:33283,ptovrint:False,ptlb:Detail1_RM,ptin:_Detail1_RM,varname:node_2887,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,ntxv:0,isnm:False|UVIN-6782-UVOUT;n:type:ShaderForge.SFN_Tex2d,id:3089,x:31757,y:33456,ptovrint:False,ptlb:Detail1_Normal,ptin:_Detail1_Normal,varname:node_3089,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,ntxv:0,isnm:True|UVIN-6782-UVOUT;n:type:ShaderForge.SFN_TexCoord,id:3528,x:30989,y:33243,varname:node_3528,prsc:2,uv:0,uaff:False;n:type:ShaderForge.SFN_Rotator,id:6782,x:31540,y:33235,varname:node_6782,prsc:2|UVIN-380-OUT,ANG-8761-OUT;n:type:ShaderForge.SFN_Slider,id:8761,x:31027,y:33459,ptovrint:False,ptlb:Detail1_rotation,ptin:_Detail1_rotation,varname:node_8761,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:-10,cur:0,max:10;n:type:ShaderForge.SFN_Lerp,id:7070,x:32291,y:32907,varname:node_7070,prsc:2|A-2562-RGB,B-3309-RGB,T-7746-OUT;n:type:ShaderForge.SFN_Lerp,id:8428,x:32296,y:33207,varname:node_8428,prsc:2|A-2887-RGB,B-8214-RGB,T-7746-OUT;n:type:ShaderForge.SFN_Lerp,id:4740,x:32556,y:33450,varname:node_4740,prsc:2|A-3089-RGB,B-2958-RGB,T-7746-OUT;n:type:ShaderForge.SFN_Tex2d,id:1255,x:31945,y:33747,ptovrint:False,ptlb:Alpha_clip_detail1,ptin:_Alpha_clip_detail1,varname:node_1255,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Multiply,id:7746,x:32089,y:33523,varname:node_7746,prsc:2|A-1312-R,B-1255-R;n:type:ShaderForge.SFN_ComponentMask,id:1319,x:32577,y:33167,varname:node_1319,prsc:2,cc1:0,cc2:-1,cc3:-1,cc4:-1|IN-8428-OUT;n:type:ShaderForge.SFN_ComponentMask,id:1109,x:32567,y:32957,varname:node_1109,prsc:2,cc1:1,cc2:-1,cc3:-1,cc4:-1|IN-8428-OUT;n:type:ShaderForge.SFN_Color,id:3156,x:32262,y:32546,ptovrint:False,ptlb:MAinColor,ptin:_MAinColor,varname:node_3156,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:0.5,c2:0.5,c3:0.5,c4:1;n:type:ShaderForge.SFN_Multiply,id:3422,x:32567,y:32755,varname:node_3422,prsc:2|A-3156-RGB,B-7070-OUT,C-5678-OUT;n:type:ShaderForge.SFN_Slider,id:5678,x:32163,y:32445,ptovrint:False,ptlb:COlorforce,ptin:_COlorforce,varname:node_5678,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0.506115,max:1;n:type:ShaderForge.SFN_ComponentMask,id:1862,x:32163,y:32250,varname:node_1862,prsc:2,cc1:0,cc2:-1,cc3:-1,cc4:-1|IN-3309-R;n:type:ShaderForge.SFN_OneMinus,id:1709,x:32320,y:32260,varname:node_1709,prsc:2|IN-1862-OUT;n:type:ShaderForge.SFN_Slider,id:8902,x:32491,y:32218,ptovrint:False,ptlb:Windows opacity,ptin:_Windowsopacity,varname:node_8902,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0.1857389,max:1;n:type:ShaderForge.SFN_Add,id:5,x:32815,y:32298,varname:node_5,prsc:2|A-8902-OUT,B-1709-OUT;n:type:ShaderForge.SFN_Clamp01,id:7248,x:32983,y:32321,varname:node_7248,prsc:2|IN-5-OUT;n:type:ShaderForge.SFN_ComponentMask,id:8659,x:32086,y:32709,varname:node_8659,prsc:2,cc1:0,cc2:-1,cc3:-1,cc4:-1|IN-2562-R;n:type:ShaderForge.SFN_OneMinus,id:3000,x:32262,y:32719,varname:node_3000,prsc:2|IN-8659-OUT;n:type:ShaderForge.SFN_Add,id:3587,x:32808,y:32442,varname:node_3587,prsc:2|A-8902-OUT,B-3000-OUT;n:type:ShaderForge.SFN_Clamp01,id:9414,x:32997,y:32442,varname:node_9414,prsc:2|IN-3587-OUT;n:type:ShaderForge.SFN_Lerp,id:6709,x:33037,y:32591,varname:node_6709,prsc:2|A-9414-OUT,B-7248-OUT,T-1312-R;n:type:ShaderForge.SFN_OneMinus,id:9033,x:32932,y:33279,varname:node_9033,prsc:2|IN-6709-OUT;n:type:ShaderForge.SFN_Color,id:6554,x:32944,y:33450,ptovrint:False,ptlb:window emission,ptin:_windowemission,varname:node_6554,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:1,c2:0.8312373,c3:0.6176471,c4:1;n:type:ShaderForge.SFN_Blend,id:2019,x:33117,y:33279,varname:node_2019,prsc:2,blmd:14,clmp:True|SRC-9033-OUT,DST-6554-RGB;n:type:ShaderForge.SFN_Power,id:3853,x:33312,y:33279,varname:node_3853,prsc:2|VAL-2019-OUT,EXP-5066-OUT;n:type:ShaderForge.SFN_Slider,id:5066,x:33157,y:33578,ptovrint:False,ptlb:EmissionPower,ptin:_EmissionPower,varname:node_5066,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:1,cur:1,max:0;n:type:ShaderForge.SFN_Multiply,id:6563,x:30932,y:32664,varname:node_6563,prsc:2|A-179-UVOUT,B-8500-OUT;n:type:ShaderForge.SFN_Multiply,id:380,x:31319,y:33044,varname:node_380,prsc:2|A-3528-UVOUT,B-8500-OUT;n:type:ShaderForge.SFN_Slider,id:8500,x:30737,y:33042,ptovrint:False,ptlb:UVsize,ptin:_UVsize,varname:node_8500,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:2,max:4;proporder:3156-8193-5678-1585-2958-8214-1255-2562-3089-2887-8761-8902-6554-5066-8500;pass:END;sub:END;*/
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float2 node_6782 = (mul((i.uv0*_UVsize)-node_6782_piv,float2x2( node_6782_cos, -node_6782_sin, node_6782_sin, node_6782_cos))+node_6782_piv);
                ...
                float2 node_5636 = (mul((i.uv0*_UVsize)-node_5636_piv,float2x2( node_5636_cos, -node_5636_sin, node_5636_sin, node_5636_cos))+node_5636_piv);
...
////// Emissive:
                float node_6709 = lerp(saturate((_Windowsopacity+(1.0 - _Detail1_color_var.r.r))),saturate((_Windowsopacity+(1.0 - node_3309.r.r))),i.vertexColor.r);
