...
///////// Gloss:
                ...
                float gloss = 1.0 - node_4319.r; // Convert roughness to gloss
                float perceptualRoughness = node_4319.r;
