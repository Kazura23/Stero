...
////// Specular:
                ...
                float3 node_7656 = lerp((lerp( node_6364, (10.0*lerp(float3(node_6364,node_6364,node_6364),_highlight_Color.rgb,(pow(1.0-max(0,dot(normalDirection, viewDirection)),(_highlight_amount+sin((node_1442.g*(_highlight_speed*7.0)))))*_highlight__force))), _highlight )+lerp( node_6364, (_emisive_force*_MainTex_var.rgb), _emissive )),dot((lerp( node_6364, (10.0*lerp(float3(node_6364,node_6364,node_6364),_highlight_Color.rgb,(pow(1.0-max(0,dot(normalDirection, viewDirection)),(_highlight_amount+sin((node_1442.g*(_highlight_speed*7.0)))))*_highlight__force))), _highlight )+lerp( node_6364, (_emisive_force*_MainTex_var.rgb), _emissive )),float3(0.3,0.59,0.11)),_Saturation);
